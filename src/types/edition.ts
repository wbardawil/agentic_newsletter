...
export const LocalizedContentSchema = z.object({
  ...
  /** Three subject line options generated by the Writer for Wadi to choose from. */
  subjectOptions: z.array(z.string()).optional(),
  /**
   * Language-appropriate transcreation of the strategic thesis. Optional
   * because EN editions fall back to `angle.thesis` directly; ES editions
